...
fn smallest_palindrome(s: String, k: i32) -> String {
...
fn main() {
    println!("{}", smallest_palindrome("abba".into(), 2));
}
...
mod tests {
    ...
    #[test]
    fn example1() {
        assert_eq!(smallest_palindrome("abba".into(), 2), "baab");
    }

    #[test]
    fn example2() {
        assert_eq!(smallest_palindrome("aa".into(), 2), "");
    }

    #[test]
    fn example3() {
        assert_eq!(smallest_palindrome("bacab".into(), 1), "abcba");
    }
}
